...
CREATE TABLE IF NOT EXISTS projects (
  ...
  payment_type TEXT DEFAULT 'once',
...
CREATE TABLE IF NOT EXISTS client_ipc (
  ...
  retention_percentage NUMERIC(5,2) DEFAULT 10,
  retention_amount NUMERIC(15,2) DEFAULT 0,
  advance_deduction_percentage NUMERIC(5,2) DEFAULT 0,
  advance_deduction_amount NUMERIC(15,2) DEFAULT 0,
  wht_percentage NUMERIC(5,2) DEFAULT 1,
